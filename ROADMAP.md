...
- **DB 어댑터로 quota·revocation·idempotency 영속** — 현재 memory/file은 단일인스턴스 + 50k FIFO 축출 시 ①revoked 토큰 부활 ②quota 리셋 ③재시작/멀티인스턴스서 웹훅 재생 가능. revoked는 절대 FIFO 축출 금지. (멀티인스턴스 위 항목과 동일 작업)
