...
const CACHE = "lensmark-shell-v16"; // v15→v16: app.html 토지선택 '따로=단일 선택'(다른 구역 클릭 시 이전 해제) 반영. S4 다리·SW 자동갱신·버전정합·부팅비콘재시도·OFFLINE 플래그·install fetch+put·빈캐시 fail-safe·updateViaCache 유지.
const SHELL = [
