/**
 * 릴리스 노트 아카이브 — 오래된 릴리스(런타임 미사용 · /api/version은 최신 8개만 서빙 · 전체 이력=CHANGELOG.md).
 *   version.ts는 최근 12개만 유지(소스 슬림). 새 릴리스는 version.ts RELEASES 맨 앞에 추가.
 */
import type { Release } from "./version";

export const ARCHIVED_RELEASES: Release[] = [
  {
    version: "0.74.3",
    date: "2026-06-14",
